...
Here are some highlights of my recent academic work:

1.  **AutoFAR: An Intelligent Hybrid System for boosting Autoformer forecasts**
    * *Published at BRACIS 2025 (Brazilian Conference on Intelligent Systems).*

2.  **An ALNS based on intelligent clustering: a solid foundation for combinatorial neural optimization**
    * *Submitted to ICAPS 2026.*

3.  **Measuring the Use of Law and Economics in Supreme Court Decisions Through a Supervised Algorithm**
    * *Presented at the 18th Congress of the Brazilian Association of Law and Economics (ABDE).*
    * *(Original title: Mensuração do Uso da AED nas Decisões do STF Através de um Algoritmo Supervisionado)*
